...
importScripts("/testprox/baremux/index.js");
...
scramjet.addEventListener("request", async (e) => {
    e.response = (async () => {
        ...
        if (!scramjet.client) {
            const connection = new BareMux.BareMuxConnection("/testprox/baremux/worker.js");
            await connection.setTransport("/testprox/epoxy/index.mjs", [{ wisp: wispConfig.wispurl }]);
